...
class ReviewQuizPage(QWidget):
    ...
    def load_review(self):
        ...
        quiz_info = QLabel(f"🧪 {data['quiz_title']} | Skor: {data['score']} | Doğru: {data['correct_count']}/{data['total_questions']}")
    ...
    def add_question_review(self, q):
        ...
        selected = next((opt for opt in q["options"] if opt["id"] == q["user_selected_option_id"]), None)
